...
$query="SELECT * FROM roles WHERE id!=3";
...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    $query="INSERT INTO users VALUES (NULL,'$name','$email','$pass1',$role,3)";
                        ...
                        <div class="p-5">
                            ...
                            <form class="user" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" name="checkpassword" class="form-control form-control-user"
                                            placeholder="Repeat Password">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <label for="" class="form-control form-control-user">Select Role</label>
                                    </div>                         
                                    <div class="col-sm-6">
                                    <select name="role" id="" class="py-2 form-control form-control-user" placeholder="Select Role">
